...
<body class="m-5">
    <h1 class="my-4">Reservation Checked In Successfully</h1>
    ...
    <p><label>Number of Bags:</label>    ${reservation.numberOfBags}</p>
    <p><label>Time of Creation:</label>    ${reservation.created}</p>
